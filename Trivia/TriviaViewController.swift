...
class TriviaViewController: UIViewController {
  ...
  private var numCorrectQuestions = 0
    private let triviaQuestionService = TriviaQuestionService() // Create an instance of TriviaQuestionService
            ...
            triviaQuestionService.fetchTriviaQuestions { [weak self] result in
                ...
                case .success(let questions):
                    ...
                    if !self.questions.isEmpty {
                        ...
                        // Handle the case where no questions were fetched (e.g., show an error message)
                        print("No trivia questions fetched.")
                    }
